...
class HandwrittenPage:
    ...
    def get_image(self):
        ...
        for stroke in self.__strokes:
            ...
            draw.ellipse((stroke[0][0]-2, stroke[0][1]-2, stroke[0][0]+2, stroke[0][1]+2), fill=(0, 0, 0))
            draw.ellipse((stroke[-1][0]-3, stroke[-1][1]-3, stroke[-1][0]+3, stroke[-1][1]+3), fill=(0, 0, 0))
        return im
